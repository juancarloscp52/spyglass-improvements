...
public class SpyglassConfigurationScreen extends Screen {
    ...
    private final HeaderAndFooterLayout layout = new HeaderAndFooterLayout(this, 50, 60);
    ...
    protected void init(){
        ...
        LinearLayout linearLayoutFooter = this.layout.addToFooter(LinearLayout.vertical().spacing(2));
        linearLayoutFooter.addChild(getResetButton());
        linearLayoutFooter.addChild(Button.builder(CommonComponents.GUI_DONE, buttonx -> this.onDone()).width(200).build());
